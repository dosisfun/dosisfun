...
pub fn create_metadata(
    ...
    let experience: ByteArray = JsonImpl::new()
        .add("trait_type", "Experience")
        .add("value", _experience)
        .build();
    let reputation: ByteArray = JsonImpl::new()
        .add("trait_type", "Reputation")
        .add("value", _reputation)
        .build();
    let total_drugs_created: ByteArray = JsonImpl::new()
        .add("trait_type", "Total Drugs Created")
        .add("value", _total_drugs_created)
        .build();
    let successful_crafts: ByteArray = JsonImpl::new()
        .add("trait_type", "Successful Crafts")
        .add("value", _successful_crafts)
        .build();
    let failed_crafts: ByteArray = JsonImpl::new()
        .add("trait_type", "Failed Crafts")
        .add("value", _failed_crafts)
        .build();
    let creation_timestamp: ByteArray = JsonImpl::new()
        .add("trait_type", "Creation Timestamp")
        .add("value", _creation_timestamp)
        .build();
    let last_active_timestamp: ByteArray = JsonImpl::new()
        .add("trait_type", "Last Active Timestamp")
        .add("value", _last_active_timestamp)
        .build();
    let is_minted: ByteArray = JsonImpl::new()
        .add("trait_type", "Is Minted")
        .add("value", _is_minted)
        .build();
    let is_active: ByteArray = JsonImpl::new()
        .add("trait_type", "Is Active")
        .add("value", _is_active)
        .build();

    let attributes = array![
        level, experience, reputation, total_drugs_created, successful_crafts, failed_crafts,
        creation_timestamp, last_active_timestamp, is_minted, is_active,
    ]
        .span();
