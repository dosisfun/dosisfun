...
pub mod ERC721DosisComponent {
    ...
    pub mod Errors {
        pub const REACHED_MAX_SUPPLY: felt252 = 'ERC721Dosis: reached max supply';
        pub const REACHED_RESERVED_SUPPLY: felt252 = 'ERC721Dosis: reserved supply';
        pub const MINTING_IS_PAUSED: felt252 = 'ERC721Dosis: minting is paused';
        pub const NOT_OWNER: felt252 = 'ERC721Dosis: not owner';
        pub const NO_RESERVE: felt252 = 'ERC721Dosis: no reserve';
        pub const INVALID_SUPPLY: felt252 = 'ERC721Dosis: invalid supply';
        pub const INVALID_ROYALTY: felt252 = 'ERC721Dosis: invalid royalty';
        pub const INVALID_ROYALTY_RECEIVER: felt252 = 'ERC721Dosis: invalid receiver';
    }

    //-----------------------------------------
    // Dosis Hooks
    //
    // your contract must implement this trait, or import ERC721DosisHooksEmptyImpl
    // see character.cairo for example
    //
    pub trait ERC721DosisHooksTrait<TContractState> {
        //
        // ERC-721 Metadata
    ...
    pub impl ERC721HooksImpl<
        ...
        impl DosisHooks: ERC721DosisHooksTrait<TContractState>,
        +Drop<TContractState>,
    > of ERC721Component::ERC721HooksTrait<TContractState> {
        fn before_update(ref self: ERC721Component::ComponentState<TContractState>, to: ContractAddress, token_id: u256, auth: ContractAddress) {
            ...
            DosisHooks::before_update(ref comp, to, token_id, auth);
        }
        fn after_update(ref self: ERC721Component::ComponentState<TContractState>, to: ContractAddress, token_id: u256, auth: ContractAddress) {
            ...
            let mut comp = HasComponent::get_component_mut(ref contract);
            // call user hook if implemented
            DosisHooks::after_update(ref comp, to, token_id, auth);
        }
    }
    ...
    > of InternalTrait<TContractState> {
        ...
        fn _get_royalty_info(self: @ComponentState<TContractState>, token_id: u256) -> RoyaltyInfo {
            (match DosisHooks::token_royalty(self, token_id) {
                // 1. Per-token royalty hook
                Option::Some(token_royalty_info) => {(token_royalty_info)},
                Option::None => { 
                    (match DosisHooks::default_royalty(self, token_id) {
    ...
    //
    #[embeddable_as(ERC721DosisMixinImpl)]
    pub impl ERC721DosisMixin<
        TContractState,
        +HasComponent<TContractState>,
        impl SRC5: SRC5Component::HasComponent<TContractState>,
        impl ERC721: ERC721Component::HasComponent<TContractState>,
    ...
    > of interface::IERC721DosisABI<ComponentState<TContractState>> {
        // ISRC5
    ...
    > of common_interface::IERC7572ContractMetadata<ComponentState<TContractState>> {
        fn contract_uri(self: @ComponentState<TContractState>) -> ByteArray {
            (match DosisHooks::render_contract_uri(self) {
                ...
                Option::None => {
                    (match DosisHooks::contract_uri(self) {
...
/// An empty implementation of the ERC721DosisHooksTrait
pub impl ERC721DosisHooksEmptyImpl<
    TContractState,
> of ERC721DosisComponent::ERC721DosisHooksTrait<TContractState> {}
